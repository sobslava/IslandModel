...
public class Factories {
    ...
    private final Map<String, ru.javarush.golf.sobolevskiy.islandmodel.factories.OrganismFactory> factoriesMap;

    private Factories() {
        factoriesMap = new HashMap<>();
        factoriesMap.put("Bear", new ru.javarush.golf.sobolevskiy.islandmodel.factories.BearFactory());
